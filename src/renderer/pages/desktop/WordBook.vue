    ...
    <div>
            ...
            <el-table
                ...
                >
                    <template slot-scope="scope">
                        ...
                        <el-link style="margin-right: 25px" type="success" @click="e => exportCategoryWords(e,scope.row)">
                            导出单词
                        </el-link>
        ...
        <el-dialog :modal="false" :visible.sync="visualNewCategory" title="新建分类" width="450px">
            <div style="text-align: center">
                <el-input v-model="inputCategory" placeholder="请输入分类名称" @keypress.enter="enterInputCategory(inputCategory)"></el-input>
                <br>
                <br>
        ...
        <el-dialog width="1000px" :close-on-click-modal="false" :modal="false" :visible.sync="visualWordManager" title="单词管理">
                ...
                <div class="word-list">
                    <div class="word-list-header">
                        ...
                        <div>
                            ...
                            <el-link type="success" @click="listenWriteChecked" style="margin: 0 10px;line-height: 20px">
                                听写选中
                            </el-link>
                            <el-link type="danger" @click="deleteCheckedWord" style="margin: 0 10px;line-height: 20px">
                                删除选中
                            </el-link>
                        </div>
                    </div>
                    <div class="word-list-item">
                        <el-table
                            ...
                            <el-table-column label="发音" width="50">
                                <template slot-scope="scope">
                                    <i class="el-icon-video-play" style="font-size: 24px;color: #409EFF;cursor: pointer"
        ...
        <el-dialog :close-on-click-modal="false" :modal="false" :visible.sync="visualListenWrite" title="单词听写" width="80%" style="overflow-x: hidden">
            <div style="height: 300px;">
                <words :category="selectCategory" :level="{name: '单词本'}" mode="WordBook" :import-words="selectWords"></words>
            </div>
        </el-dialog>
    </div>
</template>
